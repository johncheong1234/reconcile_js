...
app.post('/reconcile_post',async(req,res)=>{
  sgx_assets = req.body['sgx']
  primo_assets = req.body['primo']
...
app.post('/reconcile_post_2',async(req,res)=>{
    sgx_assets = req.body['sgx']
    primo_assets = req.body['primo']
...
app.get('/reconcile',async(req,res)=>{
  const sgx_data = await axios.get('http://localhost:3002/upload_sgx_dict_complex')
  const sgx_assets = sgx_data.data;

  const primo_data = await axios.get('http://localhost:3002/upload_primo_dict_complex')
